...
class _ReportsViewState extends State<ReportsView> {
  ...
  DateTime _dateFrom = DateTime.now().subtract(const Duration(days: 1)).copyWith(hour: 0, minute: 0, second: 0, millisecond: 0, microsecond: 0);
  DateTime _dateTo = DateTime.now().copyWith(hour: 23, minute: 59, second: 59, millisecond: 0, microsecond: 0);
